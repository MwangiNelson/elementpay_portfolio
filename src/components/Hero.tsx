          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 max-w-xl animate-slide-in-delay-3">
                Build seamless stablecoin payment infrastructure across Africa with our enterprise-grade APIs. 
                From mobile money integration to cross-border settlements, we handle the complexity so you can focus on growth.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-slide-in-delay-3 pb-10">
              ...
              <a href="https://docs.elementpay.net" target="_blank"> 
